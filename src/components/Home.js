    ...
    <div className="body min-h-screen">
      ...
      <div className="mt-5 max-w-sm mx-auto">
        ...
        <p className="mt-5 ml-5" style={{ fontFamily: "Roboto, sans-serif" }}>
          ...
          be involved including; <br/><br/> 1.WORKSHOPS / PRESENTATIONS <br /> 2.STALLHOLDERS<br/>
          3.FOOD VENDORS <br /> 4.HEALING HAVEN <br />
          4.COMMUNITY ART <br />
          5.COMMUNITY GROUPS / LIVED EXPERIENCE SPACE <br />
          6.VOLUNTEERS <br /> <br/> Want to be involved in other ways?
          We would love to hear from you! <br /> <br/> Please  
          <a href="mailto:shadybett540@gmail.com" style={{ color: 'blue', fontWeight: 'medium', textDecoration: 'none' }}> click to send us an email</a>
          <br /><br/>
          *** Please know that ALL staff must be female or identify as female as
          Bohemian Summer Festival is a women only event. <br /> <br/>*** There will
          be no refunds/transfers for change of mind therefore please consider this
          before applying.
